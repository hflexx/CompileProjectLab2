...
namespace frontend
{
    ...
    struct Analyzer
    {
        ...
        void analysisFuncRParams(FuncRParams *, vector<ir::Operand> &, vector<ir::Instruction *> &,ir::Function *);
        ...
        void analysisConstInitVal(ConstInitVal *, vector<ir::Instruction *> &, ir::Type,string);
        ...
        void analysisInitVal(InitVal *, vector<ir::Instruction *> &,ir::Type);
    };
